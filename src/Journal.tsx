...
export function Journal({ id, onBack }: { id: string; onBack: () => void }) {
  ...
  const addEntry = () => {
    ...
    /**
     * Task 1: Create a new Transaction instance from the @mysten/sui/transactions module.
     */
    const tx = new Transaction();

    /**
     * Task 2: Execute a call to the `journal::add_entry` function to add a new entry to the journal.
